...
export default function SearchBar() {
    ...
    return (
        <div className="relative flex items-center">
            ...
            <input 
                className={`text-input mt-0 py-1 px-2 absolute right-12 w-80 ${visible ? 'translate-x-0 opacity-100 pointer-events-auto' : 'translate-x-3 opacity-0 pointer-events-none'} duration-300 transition transform md:w-36 lg:w-72`} 
                value={searchedTerms} 
